...
namespace UnitTests
{
    static class TestData
    {
        ...
        public static IList<User> GetUsers()
        {
            ...
            {
                new User() {UserId = 4566, EmployeeId=45895, FirstName ="Ashok", LastName="Kumar"},
                new User() {UserId = 34456, EmployeeId=12356, FirstName ="Naresh", LastName="Gr"},
                new User() {UserId = 4566, EmployeeId=88, FirstName ="Ashok1", LastName="Kumar7"},
                new User() {UserId = 8990, EmployeeId=77, FirstName ="Naresh1", LastName="Gr6"},
                new User() {UserId = 12, EmployeeId=55, FirstName ="Ashok22", LastName="Kumar5"},
        ...
        public static IList<ParentTaskDetail> GetParentTaskDetails()
        {
            return new List<ParentTaskDetail>()
            {
                  new ParentTaskDetail() {ParentId = 112,   ParentTask ="Initial Design of Project Management API" },
                  new ParentTaskDetail() {ParentId = 112,   ParentTask ="DATABASE DESING" }
            };
        }
    }
}
